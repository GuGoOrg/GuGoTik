...
type IsFavoriteRequest struct {
	...
	ActorId uint32 `protobuf:"varint,1,opt,name=actor_id,json=actorId,proto3" json:"actor_id,omitempty"` // 用户id
	VideoId uint64 `protobuf:"varint,2,opt,name=video_id,json=videoId,proto3" json:"video_id,omitempty"` // 视频id
}
...
func (x *IsFavoriteRequest) GetVideoId() uint64 {
	if x != nil {
		return x.VideoId
	}
	return 0
...
type CountFavoriteRequest struct {
	...
	VideoId uint64 `protobuf:"varint,1,opt,name=video_id,json=videoId,proto3" json:"video_id,omitempty"` // 视频id
}
...
func (x *CountFavoriteRequest) GetVideoId() uint64 {
	if x != nil {
		return x.VideoId
	}
	return 0
...
type CountFavoriteResponse struct {
	...
	Count      uint64 `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"` // 点赞数
}
...
func (x *CountFavoriteResponse) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *CountUserFavoriteResponse) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *CountUserTotalFavoritedResponse) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07,
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x2c, 0x0a, 0x12, 0x49, 0x73, 0x46, 0x61, 0x76,
	...
	0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a,
	0x08, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xc2,
