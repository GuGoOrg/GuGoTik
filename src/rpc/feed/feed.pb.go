...
var file_feed_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x32, 0xed, 0x02, 0x0a,
	0x0b, 0x46, 0x65, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x0a,
...
var file_feed_proto_depIdxs = []int32{
	...
	7, // 6: rpc.feed.FeedService.QueryVideoSummaryAndKeywords:input_type -> rpc.feed.QueryVideoSummaryAndKeywordsRequest
	2, // 7: rpc.feed.FeedService.ListVideos:output_type -> rpc.feed.ListFeedResponse
	4, // 8: rpc.feed.FeedService.QueryVideos:output_type -> rpc.feed.QueryVideosResponse
	6, // 9: rpc.feed.FeedService.QueryVideoExisted:output_type -> rpc.feed.VideoExistResponse
	8, // 10: rpc.feed.FeedService.QueryVideoSummaryAndKeywords:output_type -> rpc.feed.QueryVideoSummaryAndKeywordsResponse
